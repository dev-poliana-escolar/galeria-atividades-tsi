...
class Biblioteca {
    livros; //cada livro é um objeto do tipo Exemplar q é um array
    // começa sem nenhum exemplar
    constructor(exemplares = []) {
        this.livros = exemplares;
    }
    // cada novo livro é um exemplar
    adicionarExemplar(novoLivro) {
        this.livros.push(novoLivro);
    }
    obterExemplares() {
        return this.livros;
    }
    obterExemplarCdd(cdd) {
...
class Exemplar {
    ...
    titulo;
    qtd;
    constructor(isbnExemplar, cddExemplar, tituloExemplar, qtdExemplar) {
